...
<script>
    // Copy script AJAX dari login.blade.php, tapi ganti rules validasinya sesuai inputan register
            ...
            submitHandler: function(form) {
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status){
                            Swal.fire({icon: 'success', title: 'Berhasil', text: response.message}).then(function() { window.location = response.redirect; });
                        }else{
