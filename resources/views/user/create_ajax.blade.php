        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Abaikan jika tidak ingin upload foto</small>
    ...
    $(document).ready(function() {
        $("#form-tambah").validate({
            rules: {
                ...
                avatar: { extension: "jpg|jpeg|png|gif" } // Validasi JS
            },
            submitHandler: function(form) {
                var formData = new FormData(form); // Wajib pakai FormData agar file terkirim
                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: formData,
