...
--
-- Host: localhost:3306
-- Generation Time: Nov 04, 2025 at 03:27 AM
...
(11, '2025_10_28_052750_create_t_penjualan_detail', 2);
...
ALTER TABLE `m_level`
  ...
  ADD UNIQUE KEY `m_level_level_code_unique` (`level_code`);
...
--
ALTER TABLE `t_penjualan`
  MODIFY `penjualan_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `t_penjualan_detail`
--
ALTER TABLE `t_penjualan_detail`
  MODIFY `detail_id` int UNSIGNED NOT NULL AUTO_INCREMENT;
